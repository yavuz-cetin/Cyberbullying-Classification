...
Original file is located at
    https://colab.research.google.com/drive/1SyrQn7IWQo8JBGITxc4Vaj5F9u4ERp7i
"""
...
model = RobertaForSequenceClassification.from_pretrained("roberta-base",num_labels = 5,id2label=id2label,label2id=label2id)
model.to(device)
...
plt.title('Roberta Tüm Kategoriler\nConfusion Matrix')
plt.show()