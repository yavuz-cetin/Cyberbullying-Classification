...
Original file is located at
    https://colab.research.google.com/drive/1_rUlSiIMzmYhZ40BGWSu6eVEatIaQ44X
"""
...
model = BertForSequenceClassification.from_pretrained("bert-base-uncased",num_labels = 5,id2label=id2label,label2id=label2id)
model.to(device)
...
plt.title('BERT Tüm Kategoriler\nConfusion Matrix')
plt.show()