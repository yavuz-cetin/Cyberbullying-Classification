...
Original file is located at
    https://colab.research.google.com/drive/1rahp9iiBx8NXtER1NBJ5kIdcJFYvarXz
"""
...
X_counts_sampled = count_vectorizer.fit_transform(X_sampled)
...
X_counts_full = count_vectorizer.transform(X)
