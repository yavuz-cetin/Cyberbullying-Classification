...
Original file is located at
    https://colab.research.google.com/drive/1K_IqJw-UnpF2a3HXIccYAuXVCU2TXHhI
"""
...
pipeline = Pipeline([
    ('countvec', CountVectorizer(**countvec_params)),
...
final_score = final_pipeline.score(X_val, y_val)
print("Validation Score on the final model:", final_score)

from sklearn.model_selection import cross_val_score
log_reg_cv = cross_val_score(final_pipeline, X_full, y_full, cv=5)
